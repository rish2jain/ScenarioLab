...
## Introduction
This Integration Guide provides step-by-step instructions and configuration guidance for MiroFish’s external integrations and deployment options. It covers:
...
## Project Structure
MiroFish is a strategic simulation platform with a frontend built on Next.js and a Python-based backend. Integrations primarily surface through:
...
### Miro API Integration for Board Export and Frame-Based Content Automation
MiroFish integrates with Miro’s REST API to:
...
References:
- Miro REST API overview and board export: [Enhancing MiroFish for Strategy Consultants.md:124](file://Research/Enhancing MiroFish for Strategy Consultants.md#L124)
- Miro REST API reference guide: [Enhancing MiroFish for Strategy Consultants.md:107](file://Research/Enhancing MiroFish for Strategy Consultants.md#L107)
- Working with sticky notes and tags: [Enhancing MiroFish for Strategy Consultants.md:111](file://Research/Enhancing MiroFish for Strategy Consultants.md#L111)
- Getting items and boards: [Enhancing MiroFish for Strategy Consultants.md:140](file://Research/Enhancing MiroFish for Strategy Consultants.md#L140)

```mermaid
sequenceDiagram
participant Client as "MiroFish Backend"
...
- [Enhancing MiroFish for Strategy Consultants.md:124](file://Research/Enhancing MiroFish for Strategy Consultants.md#L124)

**Section sources**
- [PRD.md:208](file://PRD.md#L208)
- [PRD.md:289](file://PRD.md#L289)
- [Enhancing MiroFish for Strategy Consultants.md:107](file://Research/Enhancing MiroFish for Strategy Consultants.md#L107)
- [Enhancing MiroFish for Strategy Consultants.md:111](file://Research/Enhancing MiroFish for Strategy Consultants.md#L111)
- [Enhancing MiroFish for Strategy Consultants.md:124](file://Research/Enhancing MiroFish for Strategy Consultants.md#L124)
- [Enhancing MiroFish for Strategy Consultants.md:140](file://Research/Enhancing MiroFish for Strategy Consultants.md#L140)

### MCP Server Setup for CLI Integration with Claude Desktop and Cursor
MiroFish exposes an MCP server wrapper around the FastAPI backend to enable:
...
- MCP as a primary workflow entry point: [Enhancing MiroFish for Strategy Consultants.md:21](file://Research/Enhancing MiroFish for Strategy Consultants.md#L21)
...
- [PRD.md:289](file://PRD.md#L289)
- [Enhancing MiroFish for Strategy Consultants.md:21](file://Research/Enhancing MiroFish for Strategy Consultants.md#L21)
...
### Local Deployment Configuration with Docker and Environment Variables
MiroFish supports local deployment using Docker and Docker Compose. The environment variables define LLM, memory, and optional Miro and MCP integrations.
...
## Conclusion
MiroFish’s integration landscape combines Miro’s board automation, MCP-based CLI workflows, and flexible LLM/memory backends. By configuring environment variables correctly and leveraging Docker, teams can deploy MiroFish in both cloud and air-gapped environments. The integration patterns outlined here enable seamless incorporation into consulting workflows and development pipelines.
...
- Miro REST API: Board export and item management
  - References: [Enhancing MiroFish for Strategy Consultants.md:107](file://Research/Enhancing MiroFish for Strategy Consultants.md#L107), [Enhancing MiroFish for Strategy Consultants.md:124](file://Research/Enhancing MiroFish for Strategy Consultants.md#L124)
